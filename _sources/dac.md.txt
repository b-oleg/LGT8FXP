...
LGT8FX8P имеет встроенный 8-битный программируемый цифро-аналоговый преобразователь (ЦАП).
В качестве источника опорного напряжения для ЦАП может быть выбрано:
...
| Бит | Имя | Описание |
|-----|-----|----------|
| 7:0 | DALR | Регистр данных ЦАП. Устанавливает величину<br>выходного напряжения ЦАП.|

#### Формула выходного напряжения:
V_DAO = V_REF * (DALR + 1) / 256, где:
<br>V_DAO – выходное аналоговое напряжение ЦАП,
<br>V_REF – источник опорного напряжения ЦАП (выбирается битами DAVS в регистре DACON).
