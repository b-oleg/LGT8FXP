...
### CPU_clk
Используется для управления работой ядра LGT8FXP и SRAM. Например, управление общими рабочими регистрами, регистрами состояния и т.д. Если тактовая частота процессора остановлена, ядро не будет выполнять инструкции и вычисления. После того, как система выполнит инструкцию SLEEP для перехода в спящий режим, тактовая частота ядра будет отключена.
### Peri_clk
...
### RCMCAL - Регистр калибровки высокочастотного генератора 32МГц
...
|-|-|-|-|
|7:0|R/W|RCMCAL|Значение калибровки|

>После включения питания системы значение регистра будет заменено значением калибровки из информации о конфигурации системы

### RCKCAL - Регистр калибровки низкочастотного генератора 32кГц
|Имя|Адрес|Значение по умолчанию|
|-|-|-|
...
|Бит|Доступ|Имя|Описание|
|-|-|-|-|
|7:0|R/W|RCKCAL|Значение калибровки|
...
### CLKPR - Регистр управления предделителем
|Регистр|Адрес|Значение по умолчанию|
|-|-|-|
|CLKPR|0x61|0x03|
