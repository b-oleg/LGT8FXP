...
|IR7|IR6|IR5|IR4|IR3|IR2|IR1|IR0|Функция|
|-|-|-|-|-|-|-|-|-|
|||||||||**ADD/SUB**|
...
### DSAL - Регистр результата операции
...
### DSAH - Регистр результата операции
