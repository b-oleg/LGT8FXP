...
| 6 | REFS2 | В комбинации с битами REFS регистра [ADMUX](#admux) используется<br>для выбора опорного напряжения АЦП.<br>Смотрите определение REFS в регистре [ADMUX](#admux).|
