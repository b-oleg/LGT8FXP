#ifndef _LGT8F328P_H_
#define _LGT8F328P_H_
...
//#define DSSD	(*((volatile uint16_t *)0x22))

#define DSDX	(*((volatile unsigned char *)0x30))	
#define DSDY	(*((volatile unsigned char *)0x31))	
// #define DSDX	(*((volatile uint16_t *)0x30))
// #define DSDY	(*((volatile uint16_t *)0x31))

#define DSA		(*((volatile uint16_t *)0x58))
...
#define TC3_vect       _VECTOR(29)   /* TC3 Interrupt Request */
...
#define PCINT3_vect       _VECTOR(27)   /* Pin Change Interrupt Request */
...
#define PCINT4_vect       _VECTOR(28)   /* Pin Change Interrupt Request */
...
#define RCMCAL	(*((volatile unsigned char *)0xD9))
